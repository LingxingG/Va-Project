The purpose of this file is to crawl the data and combine all csv into one single file.
...
if (file_test("-f", file_location )){
  ...
  DT <- melt(DT, id=c("Station","Year","Month","Day"))
  print("File Loaded!")
}else{
  setwd("raw data\\")
  ...
  DT <- melt(DT, id=c("Station","Year","Month","Day"))
  setwd("..\\")
  write_csv(DT,file_location,row.names=F)
  print("File Created!")
}
```
